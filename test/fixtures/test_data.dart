...
class TestData {
  ...
  /// 最小限の情報のユーザーを返す
  static User minimalUser() =>
      const User(login: 'minimaluser', name: 'Minimal User');

  /// 無効なユーザー（空文字列を含む）を返す
  static User invalidUser() => const User(login: '', name: '');
  ...
  /// 有効なContributionを返す
  static Contribution validContribution() =>
  ...
  static ContributionStatistics validContributionStatistics() =>
  ...
  static ContributionStatistics zeroContributionStatistics() =>
      const ContributionStatistics(
  ...
  /// 有効なUserRankingを返す
  static UserRanking validUserRanking() =>
      UserRanking(user: validUser(), contributionCount: 100, rank: 1);

  /// UserRankingリストを返す
  static List<UserRanking> userRankingList() => [
    UserRanking(user: validUser(), contributionCount: 100, rank: 1),
    UserRanking(user: userList()[1], contributionCount: 80, rank: 2),
